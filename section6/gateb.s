 ...
 * ================================================================== */
 ...
 _start:
 			...
 			mov r0,#0			@initialize r0 to 0 will decide the operation
			mov r3,#0 			@initialize r3 to 0
			mov r4,#0xff		@set r4 =11111111	
 ...
 logic_fnc:
 			...
 			ldr pc,[r5,r0,lsl #2]	@PC=r5+r0*4 this will set the pc to the desired operation
...
do_N_or:
		orr r3,r1,r2				@r3=r1+r2
		mvn r3,r3		   @r3=11111111 + Not(r3)
		mov pc,lr				@return

do_N_xor:
		eor r3,r1,r2         @r3=r1 xor r2
		mvn r3,r3			@r3=11111111 xor Not(r3)
		mov pc,lr            @return
.end 